...
const { scenario } = require('cucumber');
...
exports.config = {
    ...
    // logLevels: {
    //     //webdriverio: 'info',
    //     'wdio-cucumberjs-json-reporter': 'trace'
    // },
    //
    ...
    */
    ...
    cucumberOpts: {
        ...
        tagExpression: '@google or @teste or @check',
    ...
    //Método que apaga a pasta reports, antes de cada cenário
    onPrepare: function () {
